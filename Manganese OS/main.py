...
###APP Imports####
import calculator #A basic calculator
import noise_machine #An ultra-basic musical software using the fossdecks internal buzzer
...
app_list = ["home", "calculator.run", "test_program.run", "noise_machine.run"]
module_list = ["home"]
